...
export const Route = createFileRoute("/countries/south-america/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "description", content: loaderData?.description ? `${loaderData.description} Air connection Travel and Tours Islamabad — Pakistan's #1 visa agency. 98% approval rate, IATA-accredited, Blue Area office.` : "" },
      { name: "keywords", content: `${loaderData?.keywords || ""}, best south america visa consultant islamabad, top south america visa agent pakistan, south america visa success rate pakistan, south america visa from pakistan 2026, Air connection Travel and Tours south america visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "Air connection Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "South America"} Visa Consultant Islamabad — Pakistan's #1 | Air connection Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://airconnection.pk/countries/south-america/${loaderData?.slug || ""}` },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_PK" },
      { property: "og:site_name", content: "Air connection Travel and Tours — Pakistan's No.1 Travel Agency" },
      { property: "og:image", content: loaderData?.image || "" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: `${loaderData?.name || ""} Visa Consultant Islamabad | Air connection Travel and Tours` },
      { name: "twitter:description", content: loaderData?.description || "" },
      { name: "twitter:image", content: loaderData?.image || "" },
    ],
    links: [
      { rel: "canonical", href: `https://airconnection.pk/countries/south-america/${loaderData?.slug || ""}` },
    ],
  }),
...
function SouthAmericaCountryPage() {
  ...
  const jsonLd = {
    ...
    name: `${country.name} Visa Consultancy — Air connection Travel and Tours Islamabad`,
    description: country.description,
    url: `https://airconnection.pk/countries/south-america/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
