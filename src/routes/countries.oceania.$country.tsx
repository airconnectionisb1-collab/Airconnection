...
export const Route = createFileRoute("/countries/oceania/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best oceania visa consultant islamabad, top oceania visa agent pakistan, oceania visa success rate pakistan, oceania visa from pakistan 2026, Air connection Travel and Tours oceania visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "Air connection Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Oceania"} Visa Consultant Islamabad — Pakistan's #1 | Air connection Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://airconnection.pk/countries/oceania/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://airconnection.pk/countries/oceania/${loaderData?.slug || ""}` },
    ],
  }),
...
function OceaniaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://airconnection.pk/countries/oceania/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
