...
export const Route = createFileRoute("/countries/east-asia/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best east asia visa consultant islamabad, top east asia visa agent pakistan, east asia visa success rate pakistan, east asia visa from pakistan 2026, Air connection Travel and Tours east asia visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "Air connection Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "East Asia"} Visa Consultant Islamabad — Pakistan's #1 | Air connection Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://airconnection.pk/countries/east-asia/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://airconnection.pk/countries/east-asia/${loaderData?.slug || ""}` },
    ],
  }),
...
function EastAsiaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://airconnection.pk/countries/east-asia/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
