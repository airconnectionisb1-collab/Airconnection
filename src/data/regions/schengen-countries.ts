export const SCHENGEN_COUNTRIES = [
  {
    ...
    intro:
      "Germany is the economic powerhouse of Europe and a top destination for Pakistani business travelers, students, and tourists. However, the German embassy in Islamabad is known for its meticulous scrutiny of visa applications. As your dedicated Germany visa consultant in Islamabad, Air connection Travel and Tours ensures your itinerary, financial proofs, and cover letters are perfectly aligned with consular expectations to maximize your approval chances.",
    docs: [
  ...
  },
  {
    ...
    intro:
      "Whether traveling to Amsterdam for tourism or business, applying for a Netherlands visa from Pakistan requires a solid application submitted via VFS Global. Our team at Air connection Travel and Tours acts as your premier Netherlands visa consultant in Islamabad. We meticulously review your financial documents and travel itinerary, ensuring you present a compelling case to the Dutch embassy.",
    docs: [
  ...
  },
  {
    ...
    intro:
      "Austria, the heart of Europe, is famous for its alpine scenery, classical music heritage, and world-class cities like Vienna and Salzburg. The Austrian embassy in Islamabad requires precise documentation, especially regarding travel insurance and financial stability. As Pakistan's leading Austria visa consultant, Air connection Travel and Tours ensures your application meets every requirement for a smooth approval.",
    docs: [
  ...
  },
  {
    ...
    intro:
      "Belgium is known for its medieval towns, Renaissance architecture, and as the headquarters of the European Union. Applications for Belgium from Pakistan are handled with strict attention to the purpose of stay. Air connection Travel and Tours ensures your documentation is robust and fully aligned with the Belgian embassy requirements in Islamabad.",
    docs: [
  ...
  },
  {
    ...
    intro:
      "Denmark, the land of the Vikings and modern Scandinavian design. The Danish embassy uses the ApplyVisa portal for applications from Pakistan. Air connection Travel and Tours guides you through the complete digital submission and physical document gathering process, ensuring strong ties to Pakistan and a clear travel plan.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
  ...
  },
  {
    ...
    intro:
      "Norway's stunning fjords and magical northern lights attract travelers worldwide. The Norwegian embassy uses the UDI portal for applications from Pakistan. Air connection Travel and Tours guides you through the complete digital submission and physical document gathering process, ensuring your financial means and return ties are clearly demonstrated.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
  ...
  },
  {
    ...
    intro:
      "Portugal offers a rich history, stunning Algarve coastlines, and vibrant cities like Lisbon and Porto. Air connection Travel and Tours provides expert help for Portugal Schengen visas, ensuring your documentation meets the exacting standards of the Portuguese consular section in Islamabad.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
  ...
  },
  {
    ...
    intro:
      "Sweden, known for its innovation, stunning nature, and high quality of life. Applications are submitted through VFS Global. Air connection Travel and Tours ensures your file is complete, with particular focus on financial means, ties to Pakistan, and clear purpose of visit.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
  ...
  },
  {
    ...
    intro:
      "The Czech Republic, with its fairytale capital Prague, is a must-visit in Central Europe. The Czech embassy processes numerous applications and presenting a well-organized file is critical. Air connection Travel and Tours specializes in Czech Republic Schengen visas with meticulous document preparation for maximum approval chances.",
    docs: [
  ...
  },
  {
    ...
    intro:
      "Estonia is a digital leader with a beautiful medieval heart. Known for its advanced e-governance and charming Old Town Tallinn, Estonia attracts tech professionals and tourists alike. Air connection Travel and Tours helps you navigate the Estonian visa process with precision, focusing on the specific requirements of the embassy.",
    docs: [
      "Original Passport with 6 months validity",
      "Schengen Visa Application Form",
  ...
  },
  {
    ...
    intro:
      "Finland, consistently rated the world's happiest country, offers stunning lakes, magical Northern Lights, and world-class education. Air connection Travel and Tours provides meticulous file preparation for the Finnish embassy, ensuring your financial documents, travel insurance, and ties to Pakistan are clearly demonstrated.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form (completed and signed)",
      "Two recent biometric Photos (White background, 35x45mm)",
  ...
  },
  {
    ...
    intro:
      "Hungary, known for its thermal baths, the majestic Danube, and the stunning Budapest Parliament building. Air connection Travel and Tours ensures your application for the Hungarian embassy is flawless, with expert preparation of financial proofs, travel plans, and all supporting documents.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Iceland, the land of fire and ice, offers unparalleled natural wonders from the Blue Lagoon to the Golden Circle. Air connection Travel and Tours guides you through the specific requirements for this unique Schengen destination, ensuring your financial stability and travel plans satisfy the Icelandic consular standards.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Latvia offers a fascinating mix of art nouveau architecture, pristine nature, and a vibrant cultural scene in Riga. Air connection Travel and Tours handles your Latvia Schengen visa application with care, ensuring precise documentation for the Latvian embassy.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Lithuania is rich in history, Baltic charm, and UNESCO World Heritage sites. Air connection Travel and Tours provides expert documentation support for the Lithuanian embassy, ensuring your visa file meets every requirement.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Luxembourg, a tiny but prosperous country and a major financial hub of the European Union. Air connection Travel and Tours assists in preparing high-quality visa files for Luxembourg, ensuring your financial documentation and travel plans meet the stringent embassy requirements.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Malta, a sun-drenched Mediterranean archipelago with a rich history spanning millennia. Air connection Travel and Tours helps you navigate the Maltese visa process smoothly, ensuring your documentation is complete and embassy-ready.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Poland is a country of resilience, stunning architecture, and rich cultural heritage from Kraków's Main Square to Warsaw's rebuilt Old Town. Air connection Travel and Tours provides comprehensive support for the Polish embassy in Islamabad, ensuring flawless documentation for your visa application.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Slovakia, home to dramatic castles, the High Tatras mountains, and the charming capital Bratislava. Air connection Travel and Tours ensures your application for the Slovakian embassy is perfectly assembled with all required documentation.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Slovenia, where the Alps meet the Mediterranean, offers breathtaking landscapes from Lake Bled to the charming streets of Ljubljana. Air connection Travel and Tours provides meticulous file preparation for the Slovenian embassy, ensuring every document is perfect.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Liechtenstein, a tiny alpine principality nestled between Switzerland and Austria, is one of Europe's most exclusive destinations. Air connection Travel and Tours guides you through all requirements for this unique Schengen destination with expert document preparation.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Croatia, the newest member of the Schengen zone, is famous for its stunning Adriatic coastline, historic Dubrovnik, and the breathtaking Plitvice Lakes. Air connection Travel and Tours handles your Croatia visa application with precision, ensuring every document meets the embassy's exacting standards.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Bulgaria joined the Schengen zone for air and sea travel in 2024, making it an exciting new European destination. From the ancient streets of Plovdiv to the stunning Black Sea coast, Air connection Travel and Tours assists in preparing your file for this beautiful Balkan destination with expert documentation.",
    docs: [
      "Original Passport (valid 6 months, 2 blank pages)",
      "Schengen Visa Application Form",
      "Two recent biometric Photos (White background)",
  ...
  },
  {
    ...
    intro:
      "Romania, a land of legends, medieval architecture, and the mythical Transylvania, joined the Schengen zone for air and sea in 2024. Air connection Travel and Tours handles your documentation end-to-end with expert precision, ensuring your application meets every embassy requirement.",
    docs: [
      "Original Passport with 6 months validity",
